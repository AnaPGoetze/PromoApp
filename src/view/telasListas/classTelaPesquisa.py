...
class TelaPesquisa:
    ...
    # def utilizando a função da class planilha, vai buscar todas as promos que tiverem o produto ou parte do
    # produto, na planilha, e vai ser inserido em uma copia, e colocado na treeview
    def procurar_promo(self):
    ...
    def criar_widget(self):
        ...
        self.botao = Button(self.janela, text="Pesquisar", command=self.procurar_promo)
